...
bool offre::affecter(int num_offre , int id_etudiant )
{
    ...
    QString res=QString::number(num_offre);
    QString res2=QString::number(id_etudiant);
    query.prepare("UPDATE OFFRES SET  NOM_ENTREPRISE=:NOM_ENTREPRISE , ETAT_OFFRE=:ETAT_OFFRE where NUM_OFFRE=:NUM_OFFRE ");
    query.bindValue(":NUM_OFFRE",res);
    query.bindValue(":ETAT_OFFRE","Affecte");
    query2.prepare("UPDATE DEMANDES SET  NOM_ENTREPRISE=:NOM_ENTREPRISE , ETAT=:ETAT where COLUMN1=:COLUMN1 ");
    query2.bindValue(":COLUMN1",res2);
    query2.bindValue(":NOM_ENTREPRISE",":NOM_ENTREPRISE");
    query2.bindValue(":ETAT","Affecte");
